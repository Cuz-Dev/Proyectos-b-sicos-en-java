public class resta {
    static int pedir_numero1(){
        while (true){
            try{
                System.out.print("Digita el primer numero a restar: ");
    ...
    static int pedir_numero2(){
        while(true){
            try{
                System.out.print("Diita el segundo numero a restar: ");
                int numero_2 = configuracion.entrada_us();
                return numero_2;
            }catch(Exception e){
                System.out.println("Dbes escribir un numero no una letra");
            }
        }
    }
    static void resultado() {
        ...
        int resultado = operacion_resta.operacion(numero_1, numero_2);
        System.out.println("Resultado resta: " + resultado);
    }

}
class operacion_resta{
